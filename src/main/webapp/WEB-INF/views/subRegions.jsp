...
<body>   
  <div id="wrapper">        
        ...
        <div class="container-fluid">
            ...
            <!-- Branches Modal -->
            <div id="branches-panel" class="modal fade" role="dialog">
                <div class="modal-dialog">
                        ...
                        <div class="modal-body">
                            <div class="panel">
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <input type="button" value="Forecast"  id = "forecastBtn"class="btn btn-primary forecastbtn" />
                                            <input type="button" value="Reload Data" class="btn btn-primary" />
                                            <input type="button" value="Un-Submit" class="btn btn-primary" />
                                        </div>
                                        <!--<div class="col-md-5 pull-right" style="padding-right:0;">
                                            <div class="col-md-4">
                                                <label>Select by Branch Type</label>
                                            </div>
                                            <div class="col-md-8">
                                    ...
                                    <div class="row mt-12">
                                        <div class="col-md-12">
                                            ...
                                            <table id="branchesTbl" class="table table-striped table-bordered dt-responsive nowrap" cellpadding="0" cellspacing="0" width="100%">
                                                <thead>
                                                    <tr>
                                            ...
                                            <div class="table-footer text-center clearfix">
                                                <div class="col-md-6">
                                                    Opportunities
                                                    <br>
                                                      <label for="male" id = "label7"></label>
                                                    
                                                </div>
                                                <!-- <div class="col-md-2">
                                                    Unfactored Amt <span style="font-size:10px;">(USD)</span>
                                                    <p>68</p>
                                                </div> -->
                                                <!-- <div class="col-md-2">
                                                    Unfactored GP <span style="font-size:10px;">(USD)</span>
                                                ...
                                                <div class="col-md-6">
                                                    Factored Amt <span style="font-size:10px;">(USD)</span>
                                                    <br>
                                                    <label for="male" class="numbers" id = "label8"></label>
                                                </div>
                                                <!-- <div class="col-md-2">
                                                    Unfactored GP <span style="font-size:10px;">(USD)</span>
                                                    <p>68</p>
